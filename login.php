...
<main class="form-signin w-100 m-auto">
    <form method="post" action="log_up.php">
        <div class="d-flex" style="align-items: center; justify-content: space-between">
            <h2>Вход</h2>
            <a href="index.php" class="d-flex align-items-center mb-5 mb-lg-0 text-white text-decoration-none">
        ...
        <small><?php echo $_SESSION['validation']['name'] ?></small>
        <button class="btn_imm btn btn-primary w-100 py-2" type="submit">Войти</button>
